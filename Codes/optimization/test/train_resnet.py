...
from src.dl import load_model, save_model, data_set, FC_Net, ResNet18, ResNet152
...
parser.add_argument("--lr", default=LR, type=float,
                    help="The epoch to be tested")
parser.add_argument("--name", default='Resnet_cls2_weightdecay_{}'.format(LR), type=str,
                    help="Whether to test after training")
args = parser.parse_args()
LR = args.lr
DEVICE = t.device(config["DEVICE"]+':'+args.gpu)
DataSet = data_set()
project_name = 'Resnet_cls2_weightdecay_{}_{}'.format(args.optimizer, LR)
# using K-fold
n_splits = 5
np.random.seed(1998)
