...
from src.dl import load_model, save_model, data_set, FC_Net
...
parser.add_argument("--lr", default=LR, type=float,
                    help="The epoch to be tested")
parser.add_argument("--name", default='BaseLine_{}'.format(LR), type=str,
                    help="Whether to test after training")
args = parser.parse_args()
LR = args.lr
DataSet = data_set()
project_name = 'BaseLine_FE_{}_{}'.format(args.optimizer, LR)
# using K-fold
n_splits = 5
np.random.seed(1998)
